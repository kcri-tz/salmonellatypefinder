# Slimmed down SalmonellaTypeFinder repository

This repository is a slimmed down copy of the upstream repository at
<https://bitbucket.org/genomicepidemiology/salmonellatypefinder>.  It
exists to enable rapid download of this CGE service.
